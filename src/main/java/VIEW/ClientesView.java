...
public class ClientesView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon("C:\\Users\\Adrian\\Desktop\\icones\\clientes menor.png")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(edtNome, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
                    .addComponent(edtID))
                .addGap(65, 65, 65)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(edtIdade, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
    ...
    private void btnApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApagarActionPerformed
        ...
        String mensagemApagar = "Deseja realmente apagar o Cliente? \n\n"
                + "Cliente: " + edtNome.getText()
                + "\n\nEsta ação não poderá ser revertida!!!";

        if (JOptionPane.showConfirmDialog(this, mensagemApagar, "Apagando Cliente", 0, 2) == 0) {
            cli.setId_cliente(Integer.parseInt(edtID.getText()));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ClientesDTO cli = new ClientesDTO();
        ComandosDAO comando = new ComandosDAO();
        cli.setIdade_cliente(Integer.parseInt(edtIdade.getText()));
        cli.setNome_cliente(edtNome.getText());
        cli.setSituacao_cliente(edtSituacao.getText().charAt(0));

        if (acao == 1) {
            comando.insereRegistro(cli);
            JOptionPane.showMessageDialog(this, "Cliente Inserido! ", "Confirmação", 1);

        } else {
            cli.setId_cliente((Integer.parseInt(edtID.getText())));
            comando.atualizaRegistro(cli);
            JOptionPane.showMessageDialog(this, "Cliente atualizado! ", "Confirmação", 1);
        }
